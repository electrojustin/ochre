...
test_model.compile(optimizer=keras.optimizers.Adam(learning_rate=0.01), loss=keras.losses.BinaryCrossentropy(), metrics=[keras.metrics.BinaryAccuracy()])
...
print('Ochre data on Ochre model')
ochre_model.evaluate(x=ochre_train_inputs, y=ochre_train_outputs)
print('Test data on Ochre model')
ochre_model.evaluate(x=test_inputs, y=test_outputs)
print('AMBER data on AMBER model')
amber_model.evaluate(x=amber_train_inputs, y=amber_train_outputs)
...
print('AMBER data on test model')
test_model.evaluate(x=amber_train_inputs, y=amber_train_outputs)
print('Ochre data on test model')
test_model.evaluate(x=ochre_train_inputs, y=ochre_train_outputs)
